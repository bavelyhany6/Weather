...
let clearness=document.getElementById('clearness');
...
async function getWeather(country='cairo'){
    ...
    clearness.innerHTML=weather.current.condition.text;
    ...
    currentDate.innerHTML=weather.forecast.forecastday[2].date;
}
getWeather()
